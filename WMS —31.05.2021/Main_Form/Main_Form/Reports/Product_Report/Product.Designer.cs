...
namespace Main_Form.Reports.Product_Report {
    ...
    public partial class Product : global::System.Data.DataSet {
        ...
        public partial class ProductDataTable : global::System.Data.TypedTableBase<ProductRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProductRow AddProductRow(string Name, string Description, decimal Price) {
...
namespace Main_Form.Reports.Product_Report.ProductTableAdapters {
    ...
    public partial class ProductTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Product] ([Name], [Description], [Price]) VALUES (@Name, @Desc" +
                "ription, @Price);\r\nSELECT ID_Product, Name, Description, Price FROM Product WHER" +
                "E (ID_Product = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Product] SET [Name] = @Name, [Description] = @Description, [Price] = @Price WHERE (([ID_Product] = @Original_ID_Product) AND ([Price] = @Original_Price));
SELECT ID_Product, Name, Description, Price FROM Product WHERE (ID_Product = @ID_Product)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID_Product, Name, Description, Price FROM dbo.Product";
        ...
        public virtual int Update(string Name, string Description, decimal Price, int Original_ID_Product, decimal Original_Price, int ID_Product) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Description, decimal Price, int Original_ID_Product, decimal Original_Price) {
            return this.Update(Name, Description, Price, Original_ID_Product, Original_Price, Original_ID_Product);
        }
    }
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        private int UpdateUpdatedRows(Product dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._productTableAdapter != null)) {
                global::System.Data.DataRow[] updatedRows = dataSet._Product.Select(null, null, global::System.Data.DataViewRowState.ModifiedCurrent);
        ...
        private int UpdateInsertedRows(Product dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._productTableAdapter != null)) {
                global::System.Data.DataRow[] addedRows = dataSet._Product.Select(null, null, global::System.Data.DataViewRowState.Added);
                if (((addedRows != null) 
                            && (0 < addedRows.Length))) {
        ...
        private int UpdateDeletedRows(Product dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._productTableAdapter != null)) {
                global::System.Data.DataRow[] deletedRows = dataSet._Product.Select(null, null, global::System.Data.DataViewRowState.Deleted);
                if (((deletedRows != null) 
